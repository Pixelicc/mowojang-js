...
describe("Functions", () => {
  ...
  describe("#getPlayerSession", () => {
    it("Should return an Player Session Object", async () => {
      ...
      assert.strictEqual(playerSession.skin.URL, "http://textures.minecraft.net/texture/56dab0d218f41af5812c4b4692719ab3b2f28ef668338f0753336c79acb6b5fa");
      ...
      assert.strictEqual(playerSession.cape.URL, "http://textures.minecraft.net/texture/2340c0e03dd24a11b15a8b33c2a7e9e32abb2051b2481d0ba7defd635ca7a933");
